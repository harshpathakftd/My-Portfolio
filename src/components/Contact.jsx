...
const CONTACT_EMAIL = "harshpathakftd@gmail.com";

const socialLinks = [
  {
    href: "https://github.com/harshpathakftd",
    icon: (
  ...
  {
    href: "https://www.linkedin.com/in/harshpathakftp",
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM4 6.228L12 12.5L20 6.228V6L12 12L4 6V6.228ZM4 8.772V18H20V8.772L12 15L4 8.772Z" fill="currentColor" />
      </svg>
    ),
    alt: "Gmail",
  },
